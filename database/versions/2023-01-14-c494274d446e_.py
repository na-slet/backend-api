...
def upgrade() -> None:
    ...
    op.create_table('channels',
                    ...
                    sa.Column('created_at', sa.TIMESTAMP(timezone=True), nullable=False),
                    sa.ForeignKeyConstraint(['creator_id'], ['users.id'], name=op.f('fk__channels__creator_id__users'),
                                            ondelete='CASCADE'),
    ...
    op.create_table('credentials',
                    ...
                    sa.Column('credential_type', postgresql.ENUM('BASIC', 'VK', 'GOOGLE', name='credentialtypes'),
                              nullable=False),
                    sa.Column('value', sa.String(), nullable=False),
                    sa.Column('created_at', sa.TIMESTAMP(timezone=True), nullable=False),
                    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk__credentials__user_id__users'),
                                            ondelete='CASCADE'),
    ...
    op.create_table('events',
                    ...
                    sa.ForeignKeyConstraint(['channel_id'], ['channels.id'],
                                            name=op.f('fk__events__channel_id__channels'), ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['creator_id'], ['users.id'], name=op.f('fk__events__creator_id__users'),
                                            ondelete='CASCADE'),
    ...
    op.create_table('booked',
                    ...
                    sa.Column('created_at', sa.TIMESTAMP(timezone=True), nullable=False),
                    sa.ForeignKeyConstraint(['event_id'], ['events.id'], name=op.f('fk__booked__event_id__events'),
                                            ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk__booked__user_id__users'),
                                            ondelete='CASCADE'),
    ...
    op.create_table('favourites',
                    ...
                    sa.Column('event_id', postgresql.UUID(), nullable=False),
                    sa.Column('created_at', sa.TIMESTAMP(timezone=True), nullable=False),
                    sa.ForeignKeyConstraint(['event_id'], ['events.id'], name=op.f('fk__favourites__event_id__events'),
                                            ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk__favourites__user_id__users'),
                                            ondelete='CASCADE'),
    ...
    op.create_table('likes',
                    ...
                    sa.Column('event_id', postgresql.UUID(), nullable=False),
                    sa.Column('created_at', sa.TIMESTAMP(timezone=True), nullable=False),
                    sa.ForeignKeyConstraint(['event_id'], ['events.id'], name=op.f('fk__likes__event_id__events'),
                                            ondelete='CASCADE'),
    ...
    op.create_table('subscribed',
                    ...
                    sa.Column('event_id', postgresql.UUID(), nullable=False),
                    sa.Column('created_at', sa.TIMESTAMP(timezone=True), nullable=False),
                    sa.ForeignKeyConstraint(['event_id'], ['events.id'], name=op.f('fk__subscribed__event_id__events'),
                                            ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk__subscribed__user_id__users'),
                                            ondelete='CASCADE'),
