...
def upgrade() -> None:
    ...
    op.create_table('participations',
                    ...
                    sa.Column('participation_stage',
                              postgresql.ENUM('INVITATION_PENDING', 'PAYMENT_NEEDED', 'PAYMENT_PENDING', 'APPROVED',
                                              'DECLINED', name='participationstages'), nullable=False),
                    sa.Column('created_at', sa.TIMESTAMP(timezone=True), nullable=False),
                    sa.ForeignKeyConstraint(['event_id'], ['events.id'],
                                            name=op.f('fk__participations__event_id__events'), ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk__participations__user_id__users'),
                                            ondelete='CASCADE'),
...
def downgrade() -> None:
    ...
    op.create_table('booked',
                    ...
                    sa.ForeignKeyConstraint(['event_id'], ['events.id'], name='fk__booked__event_id__events',
                                            ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='fk__booked__user_id__users',
                                            ondelete='CASCADE'),
